class ScoutApp {
    ...
    resetReport() {
        return { name: '', teamId: '', position: '', role: '', age: '', height: '', foot: 'Sağ', marketValue: '', image: '', source: '', matchId: '', tmUrl: '', sofaUrl: '', potential: 'Düşük', stats: {} };
    }
    ...
    closeModal() { const tip = document.getElementById('similar-breakdown-tooltip'); if (tip) tip.classList.add('hidden'); document.getElementById('modal-overlay').classList.add('hidden'); }
